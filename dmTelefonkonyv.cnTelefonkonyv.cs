...
// Code is generated on: 4/5/2025 18:38:06
//
...
namespace Telefonkonyv
{
    ...
    public partial class cnTelefonkonyv : DbContext
    {
        ...
        private void SzemelyMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Szemely>().Property(x => x.SzemélyId).HasColumnName(@"SzemélyId").IsRequired().ValueGeneratedOnAdd();
        ...
        private void RelationshipsMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Szemely>().HasMany(x => x.Számok).WithMany(op => op.Személyek)
                .UsingEntity<Dictionary<string, object>>(
                    @"SzemelyekSzamok",
                    x => x.HasOne<Szam>().WithMany().HasPrincipalKey(@"SzámId").HasForeignKey(@"SzámId"),
                    x => x.HasOne<Szemely>().WithMany().HasPrincipalKey(@"SzemélyId").HasForeignKey(@"SzemélyId")
                )
                .ToTable(@"SzemelyekSzamok");
